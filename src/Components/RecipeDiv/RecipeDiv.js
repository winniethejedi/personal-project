...
import { ingredientsToRecipeAction, categoriesToRecipeAction, userToRecipeAction } from '../../Redux/Actions/actions';
...
function mapDispatchToProps(dispatch){
  return bindActionCreators({ ingredientsToRecipeAction, categoriesToRecipeAction, userToRecipeAction }, dispatch);
}
